...
namespace DeadManSwitch.Service.WebApi.Host
{
    public class AppSettingReader : IHostSettingsReader
    {
        ...
        {
            if(ConfigurationManager.AppSettings.AllKeys.Contains(key) == false) throw new Exception($"Application Setting {key} does not exist and no default value was specified.");
